...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    {
        cell.titleColor                 = _buttonsTitleColors ? _buttonsTitleColors[indexPath.row] : _buttonsTitleColor;
        ...
        cell.font                       = _buttonsFonts ? _buttonsFonts[indexPath.row] : _buttonsFont;
...
- (CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else if (_buttonsNumberOfLines != 1)
    {
        ...
        label.font                      = _buttonsFonts ? _buttonsFonts[indexPath.row] : _buttonsFont;
